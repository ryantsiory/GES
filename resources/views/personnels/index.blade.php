...
<div class="br-pagebody">
  <div class="br-section-wrapper">
    ...
    <p class="br-section-text">Données concernant les employés de l'Entreprise.</p>

    <a href="{{ route('personnels.create') }}" class="btn btn-info mb-2 float-right">Nouveau personnel</a>
      ...
      <table class="table mg-b-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{ route('personnels.show',  $personnel->id) }}">
